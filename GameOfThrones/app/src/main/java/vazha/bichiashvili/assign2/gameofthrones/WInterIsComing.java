...
/**
 * Created by GeoLab on 11/12/16.
 */

public class WInterIsComing {

    public static String[] names = new String[]{"Tyrion Lannister", "Jon Snow", "Daenerys Targaryen",
            "Cersei Lannister", "Ser Jorah Mormont", "Samwell Tarly"};

    public static String[] descriptions = new String[]{"Tyrion is the third and youngest son of Lord Tywin and Lady Joanna Lannister. He is a dwarf.\n" +
            "\n" +
            ...
            "Ser Jorah is the son of Ser Jeor Mormont, Lord Commander of the Night's Watch.\n" +
                    "\n" +
                    "A knight and former heir to Bear Island, Ser Jorah fled the Seven Kingdoms into exile after illegally selling some poachers into slavery. Five years later, he joined the service of Viserys Targaryen and his sister, Daenerys Targaryen, the exiled claimant to the Iron Throne of the Seven Kingdoms.\n" +
                    "\n" +
                    "He is Dany's most trusted advisor but may also harbor romantic feelings for her. He is pained by his shameful past and seeks to do right. He is a sharp observer and is fluent in Dothraki.",
            "Samwell Tarly is the eldest son of Lord Randyll Tarly. Although he was noble born, on his eighteenth birthday his father cast him out, telling him to become a \"crow\" of the Night's Watch or he would be part of a hunting accident, not surviving. Although overweight, clumsy, timid, and unsure of himself, Sam is intelligent, thoughtful, and very kind. He is a steward of the Night's Watch. He is an avid reader, a good cook, and can be resourceful in his mind if not quick on his feet. He becomes a close friend and confidant to fellow \"crow\" Jon Snow."
    };

    public static String[] images = new String[]{"http://ia.media-imdb.com/images/M/MV5BMjA2MDAwOTI0OV5BMl5BanBnXkFtZTcwNjA3NDg1Nw@@._V1__SX1857_SY919_.jpg",
            "http://ia.media-imdb.com/images/M/MV5BMTkwMjUxMDk2OV5BMl5BanBnXkFtZTcwMzg3MTg4OQ@@._V1__SX1857_SY919_.jpg",
            "http://ia.media-imdb.com/images/M/MV5BMjA4MzIxMTQwMF5BMl5BanBnXkFtZTcwMzY2NDg1Nw@@._V1__SX1857_SY919_.jpg",
            "http://ia.media-imdb.com/images/M/MV5BMTgzNTAxNjExMl5BMl5BanBnXkFtZTcwMDEwNzI4OQ@@._V1._CR954,56,605,670__SX1857_SY919_.jpg",
            "http://ia.media-imdb.com/images/M/MV5BMTkzNTcxMDI2NV5BMl5BanBnXkFtZTcwMzgxNzI4OQ@@._V1._CR225,437,407,405__SX1857_SY919_.jpg",
            "http://ia.media-imdb.com/images/M/MV5BMTQyODYyOTczMF5BMl5BanBnXkFtZTcwNjY0ODg4OQ@@._V1__SX1857_SY919_.jpg"
    };
}
